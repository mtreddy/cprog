...
/* This code is from liboqs/tests directory.
 * gcc test_sig.c -o test_sig -I../build/include   -L../build/lib/  -loqs
 * export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/tmarri/src/crypto/ssl/liboqs/build/lib/
 * RUN test:  ./test_sig  Dilithium2
 */
#if defined(_WIN32)
